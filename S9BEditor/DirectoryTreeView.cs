...
internal class DirectoryTreeView : TreeView
{
	...
	{
		if (((RoutedEventArgs)e).Source is DirectoryTreeViewItem { IsValid: not false, IsDirectory: false } directoryTreeViewItem)
		{
	...
	protected override void OnItemsChanged(NotifyCollectionChangedEventArgs e)
	{
		if (e.NewItems != null)
		{
			...
			{
				if (newItem is DirectoryTreeViewItem { IsDirectory: not false } directoryTreeViewItem)
				{
		...
		if (e.OldItems != null)
		{
			...
			{
				if (oldItem is DirectoryTreeViewItem { IsDirectory: not false } directoryTreeViewItem2)
				{
