...
internal class ExportContextActionsProvider : IActionProvider, IAsyncTaskProvider, IToolBarProvider, IToolBar
{
	...
	private abstract class ExportActionItem : IWPFActionItem, IUriProviderActionItem, IActionItem
	{
		...
		protected string GetDisplayText()
		{
			return Type switch
			{
				ExportActionItemType.ExportThis => "Export This Only", 
				ExportActionItemType.ForcedExportThis => "Force Export This Only", 
				ExportActionItemType.Export => "Export With References", 
				ExportActionItemType.ForcedExport => "Force Export With References", 
				ExportActionItemType.CancelExport => "Cancel Export", 
				ExportActionItemType.Preview => "Preview", 
				_ => string.Empty, 
			};
		}
		...
		public Uri GetResourceURI(ActionItemResourceType ResourceType)
		{
			return Type switch
			{
				ExportActionItemType.ExportThis => new Uri("pack://application:,,,/Resources/ExportOneHS.png"), 
				ExportActionItemType.Export => new Uri("pack://application:,,,/Resources/ExportHS.png"), 
				ExportActionItemType.Preview => new Uri("pack://application:,,,/Resources/FormRunHS.png"), 
				ExportActionItemType.CancelExport => new Uri("pack://application:,,,/Resources/StopHS.png"), 
				_ => null, 
			};
		}
	}
